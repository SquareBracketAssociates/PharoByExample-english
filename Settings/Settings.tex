...
\apl{I don't really understand what you mean by "scripting settings"}
...
\sd{may be we should say a word about CodeHolderSystemSettings}
...
\sd{would be nice to know the API}
...
\ct{PragmaCollector}. For example, the following code returns a collector which contains all the methods
defining the pragma named \ct{'systemsettings'}.
