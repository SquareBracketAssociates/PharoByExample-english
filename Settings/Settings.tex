...
\begin{itemize}
\item 
	to declare the new setting with the \ct{#range:} message instead of the \ct{#setting:} message and
\item
	to declare the valid range by sending the \ct{#range:} message to the newly declared setting with an \ct{Interval} as argument.
\end{itemize}
