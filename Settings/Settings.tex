...
A setting is declared by a particular class method which must be coded as follow: it takes a builder as argument and it is tagged by the <systemsettings> simple pragma. As an example: 
\begin{code}{}
AClassInMyPackage class>>systemSettingOn: aBuilder
  <systemsettings>
