...
CodeHolderSystemSettings class>>caseSensitiveFindsSettingsOn: aBuilder
	...
	(aBuilder setting: #caseSensitiveFinds) 
		target: ParagraphEditor
\end{code}
This very short version is enough to be compiled and taken into account by the settings browser as shown by the screenshot below:
\begin{figure}[tbh]
\begin{center}
\includegraphics[scale=0.45]{caseSensitiveFinds_setting_declaration2}
