...
Being able to declare its own settings as a child of a pre-existing node is very useful especially when a package wants to enrich existing standard settings.  
