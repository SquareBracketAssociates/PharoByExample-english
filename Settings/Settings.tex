...
\includegraphics[scale=0.38]{smart-subtree1}
\end{minipage}
\begin{minipage}[t]{0.49\linewidth}
\includegraphics[scale=0.38]{smart-subtree2}
\end{minipage}
...
In order to handle such optional settings the only thing is to declare them as children of a parent setting which actual value is a boolean. In this case, children settings are shown only if the parent value is \ct{true}.
