...
Concerning the classification of your setting, there are several ways to do it and this point is fully detailed in Section~\ref{sec:OrganisingYourSettings}. For now, the simplest way to declare your setting as a child of another setting is to use the \ct{#parent:} message with the identifier of the parent setting passed as argument. 
