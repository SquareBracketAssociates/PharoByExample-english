...
Pharo1.1 contains and uses the Settings framework to manage its preferences. However Settings is not limited to manage Pharo preferences but can be used by any applications. The nice thing about Settings is that it is 
not intrusive, support a modular decomposition of software and can be added to an application after its inception. 
