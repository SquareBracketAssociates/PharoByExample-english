...
\ifluluelse
	{\centerline {\includegraphics[scale=0.4]{atoms}}}
	{\centerline {\includegraphics[scale=0.7]{atoms}}}
...
%\click{ing} on the right-pointing triangle by the name of a package reveals a list of available versions. When a package or a version is selected, information about it appears in the right-hand pane.
