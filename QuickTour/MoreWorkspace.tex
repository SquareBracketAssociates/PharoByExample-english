...
% HISTORY:
% 2007-06-10 - Oscar split off More Workspace stuff
...
%	\caption{A workspace containing some text.\figlabel{workspacetext}}
%	%	\end{figure}
...
\begin{table}[htbp]
   ...
   \tablabel{GeneralEditingCommands}} 	% requires the topcapt package
...
\begin{table}[htbp]
   ...
   \tablabel{Search}} 				% requires the topcapt package
   \begin{tabular}{cp{5in}c} 		% Column formatting, @{} suppresses leading/trailing space
      \toprule
      key    & description &\\
      \midrule
...
\begin{table}[htbp]
   ...
   \tablabel{Accept}} 				% requires the topcapt package
   \begin{tabular}{cp{5in}c} 		% Column formatting, @{} suppresses leading/trailing space
      \toprule
      key    & description &\\
      \midrule
...
\begin{table}[htbp]
   ...
   \tablabel{Actions}} 				% requires the topcapt package
   \begin{tabular}{cp{5in}c} 			% Column formatting, @{} suppresses leading/trailing space
      \toprule
      key    & description &\\
      \midrule
