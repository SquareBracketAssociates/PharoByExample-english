...
\ml{There's a lot of overlap between the first two parts and the third part. I suggest that stuff mentioned in the first two parts is removed from the third and that instead the third part could also focus on how to extend Filesystem. E.g by explaining how the ZIP filesystem works.}
