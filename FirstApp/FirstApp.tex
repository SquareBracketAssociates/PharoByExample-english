...
\dothis{Add the method \ct{LOCell>>>mouseUp:} and then \menu{automatically categorize} methods.}
\index{method!categorize}
...
\dothis{\Actclick on the \scat{PBE-LightsOut} package and \menu{fileOut} the contents.}
...
%:===> File-out package needs to be implemented! (On DR's to-do list)
\on{currently this does not work --- DR has said he will do it.}
