...
We drop the carry we obtained when from the addition. So we obtain 5. Note that on binary representation the carry results in overflow because there will be not enough bits to represent it).
...
$60 - 80 = 60 - (100 - 20) = 80 - 100 = -20$. Notice that we do not do the (100-20) operation this is just to make easier to you to follow: $60-80$ just requires to compute the complement and perform one addition.
