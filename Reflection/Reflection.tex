...
\begin{figure}[ht]\centering
	...
	\caption{Dynamically creating accessors.\figlabel{DynamicAccessors} \alex{not sure whether the figure is highly necessary. The code is rather simple and the figure complete to follow in my opinion.}}
\end{figure}
