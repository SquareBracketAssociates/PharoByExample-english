...
A \emphind{pragma} is an annotation that specifies data about a program, but is not part of the program itself. Pragmas have no direct effect on the operation of the method they annotate.
...
\begin{code}{@TEST}
(MorphObjectOut>>>#doesNotUnderstand:) pragmas
  --> an Array(<lint: 'Unnecessary "= true"' rationale: 'recursionFlag may be nil' author: 'stephane.ducasse'>)
