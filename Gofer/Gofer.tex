...
%    user: 'pharoUser' 
%    password: 'pharoPwd'
%Pour ceci, les mŽthodes url:, url:username:password: or directory: sont disponibles. Les deux premires permettent de spŽcifier des accs HTTP ou FTP, la troisime permet de spŽcifier tout type d'URL. Cette dernire sera utilisŽe dans des cas particuliers comme charger des packages depuis un dossier local.
