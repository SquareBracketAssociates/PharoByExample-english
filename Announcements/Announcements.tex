...
\begin{figure}[ht]\centering
	\includegraphics[height=8cm]{AnnouncementFlow}
...
We saw that you can create your own announcements to communicate between objects, but there is already existing announcement, all subclass of \ct{SystemAnnouncement}, managed by the system to inform that it changed.
