...
(Actually, you will see that we told a white lie\,---\,\ct{Object class superclass -->} {\clsind{ProtoObject class}, not \ct{Class}. In \squeak, we must go one superclass higher to reach \ct{Class}.)
