...
\item Open the image and load the package ÒConfigurationOfCoralÓ from ÒCoralÓ SqueakSource repository. The fastest way is to evaluate:
...
Note that these scripts remember the locations and names of your virtual machine and of your Coral image. YouÕll have to generate them again if any of these information changes.
...
\end{code}
 ...
 This message  takes all selectors in CoralScriptExamples class in the Òscript examplesÓ category, and generate a file for each selector, which content will be the return value (a string containing a Coral script) of the evaluation of the selector.
