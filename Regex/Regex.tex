...
\sloppy
%=================================================================
\chapter{Regular Expressions in \pharo}\label{cha:regex}
...
\pharo also supports regular expressions due to the Regex package contributed by Vassili Bykov.
Regex is installed by default in \pharo. If you are using an older image that does not include Regex the Regex package, you can install it yourself from SqueakSource\footnote{\url{http://www.squeaksource.com/Regex.html}}.
