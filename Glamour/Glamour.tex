...
This code extends the previous one with a title as well as directory
entry sorting, access permission handling and file content reading.
The resulting browser is presented in
\figref{casestudies/file_finder}.

This short
introduction has just presented how to install Glamour and how to use
it to create a simple file browser. The following will present a more
complete example as well as detailed information about the framework.

\section{Tutorial: Implementing a code browser}

This chapter serves as a hands-on introduction to our reference
implementation.
...
The listing below shows how to
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=6cm]{helloworld.pdf}}
