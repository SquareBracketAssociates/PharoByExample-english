...
\caption{	Improved class navigator including a tree to display the packages and a list of method categories for the selected class.\alex{Why is visualworks shown in the figure? Where did we get this figure from? This is not Pharo apparently}}
...
world by using \ct{sendToOutside:from:} \ja{sendToOutside:from: or sendToOutside: ?}\alex{ sendToOutside: has no implementor}. For this we
