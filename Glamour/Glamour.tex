...
\ja{i cannot load this code in PharoCore 1.3. We need a stable version} \ab{Strange, I just tried and it works with a 13299} 
\begin{code}{}
Gofer new
...
\ja{does it work with RPackage or Categories or both ?}\ab{It works with RPAckage only, there is a ref to RPackageOrganizer}
...
At this point, we can also add Pane~3 to list the method categories (\figref{classnavigator_wireframe}) \ja{Is it not fig:treeandcategories  (fig 1.4)?}. The listing
...
Adding Pane 4 to list the method is slightly more complicated. When a
