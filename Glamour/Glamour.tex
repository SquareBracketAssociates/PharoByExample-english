...
Glamour is designed to be simple to use in the sense that the creator
of a Glamour's script can implement his browser rapidly and the
maintainer of the script will be able to read and understand the
script without trouble.
