...
Lets start by looking at the main tools in \pharo, all of which can be dragged out of the \toolsflapind in the \sbe image (see \secref{sbeImage}).
Depending on your personal settings, the \toolsflap{} can be opened by mousing over or clicking on the orange tab on the right-hand edge of \pharo's main window.
...
There are actually several browsers in \pharo: the standard system browser, the package browser, the Omnibrowser, and the Refactoring Browser. 
...
Suppose that you are developing a framework named to facilitate the use of relational databases from \pharo. You have decided to call your framework \ct{PharoLink}, and have created a series of system categories to contain all of the classes that you have written, \eg
...
There are two tools in \pharo to help you find messages; both can be dragged out of the \toolsflapind.
