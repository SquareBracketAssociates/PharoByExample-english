...
In some situations, it will never makes sense to resume an exception, in which case you should signal a non-resumable subclass\,---\,either an existing one or one of your own creation.
