...
\MC is included in the standard Squeak distribution\footnote{\url{http://www.squeak.org}} and in the image for developers\footnote{\url{http://damiencassou.seasidehosting.st/Smalltalk/squeak-dev}}\alex{The distributed Pharo will be the image for developpers}. 
...
\item All classes in the system category \scat{Perfect}, or in system categories whose names start with \scat{Perfect-}. For now this includes only our \ct{PerfectTest} class.
...
\alex{This subsection will need a major overhaul when turning the chapter for Pharo. The merging tool is radically different}
...
\important{An mcz file can be dragged and dropped onto an open image file, just like a change set. \Squeak will then prompt you to ask if you want to load the package it contains.}
