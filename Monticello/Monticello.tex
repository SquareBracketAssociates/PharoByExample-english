...
\begin{itemize}
\item If you load \ct{Perfect-All} from a repository (package-ccache, or anywhere else), this will cause \ct{Perfect-Extensions} and \ct{Perfect-Tests} to be loaded from the same repository.
