...
It interacts on connections while the \ct!isRunning! flag is \ct!true!.
After a \ct!stop!, the connection is destroyed and the serving process is terminated. 
	
%%%%%%CONTINUE FROM HERE
Now, let's go back to the \ct!start! method.
