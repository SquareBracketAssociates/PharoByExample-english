...
\end{code}
As you can see, we introduced the protocol \ct{asClient}, which answers a representation in JavaScript, and you can then send messages of the jQuery package.
