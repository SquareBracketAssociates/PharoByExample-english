...
- Browsing code; nice queries\\
- Applications of Introspection: code metrics; code smells; smart breakpoints\\
- Methods as Objects; compiled methods; wrappers; spy\\
MORE\\
- method wrappers: coverage; memoization\\
- trap msgs sent to an object\\
- pointer finder\\
